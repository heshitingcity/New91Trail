...
class ExcelUtils(object):
    ...
    def get_sheet_data_by_list(self): #把excel的数据通过列表返回 [ [] , [] , [] ]
        all_excel_data = []
        for rownum in range(1,self.get_row_count):
            row_excel_data = []
...
if __name__ == '__main__':
    ...
    print(current_path)
    sheet_infos = ExcelUtils("D:\city\\UI\\New91Trail\\test_case_datas\login_suite\login_case_data.xlsx",'Login').get_sheet_data_by_list()
    print( sheet_infos )